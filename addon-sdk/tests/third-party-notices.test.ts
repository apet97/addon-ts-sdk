...
describe("third-party notices", () => {
  it("retains the complete AJV and fast-deep-equal MIT notices", () => {
    ...
    expect(notice.match(/Permission is hereby granted, free of charge/gu)).toHaveLength(2);
    expect(notice.match(/THE SOFTWARE IS PROVIDED "AS IS"/gu)).toHaveLength(2);
  });
