...
import { assertStandaloneValidatorSafety } from "./standalone-validator-safety";
...
function generateManifestValidators(
  ...
  const output = `${STANDALONE_VALIDATOR_HELPERS}\n${generated.trimEnd()}\n`;
  assertStandaloneValidatorSafety(output);
