...
This document tracks Java parity requirements and the reviewed TypeScript adaptations.
...
- [x] TS schemas 1.5 and 1.6 match the live Clockify manifest schema endpoint structurally
...
- [x] Support schema versions 1.5 and 1.6 in addition to 1.2, 1.3, and 1.4
...
- [x] v1.6 webhook builders expose `TIME_OFF_REQUEST_STARTED`
- [x] v1.6 component builders expose `timeentries.action.uiblocks`
- [x] Runtime validation and generated-drift checks cover schemas 1.2-1.6
